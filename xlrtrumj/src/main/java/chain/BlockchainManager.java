...
import org.solarisj.core.CheckpointManager;
...
import org.solarisj.core.TransactionBroadcast;
...
import org.solarisj.net.discovery.MultiplexingDiscovery;
                    ...
                    peerGroup.addPeerDiscovery(new PeerDiscovery() {
                        ...
                        public InetSocketAddress[] getPeers(final long services, final long timeoutValue, final TimeUnit timeoutUnit)
                            ...
                            if (hasTrustedPeer) {
                                ...
                                for (XlrtrumPeerData xlrtrumPeerData : XlrtrumGlobalData.listTrustedHosts()) {
                                    peers.add(new InetSocketAddress(xlrtrumPeerData.getHost(), xlrtrumPeerData.getTcpPort()));
                                }
                            }
