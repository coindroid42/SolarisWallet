...
import xlrtrum.messages.BaseMsg;
import xlrtrum.messages.GetBalanceMsg;
import xlrtrum.messages.GetHeader;
import xlrtrum.messages.GetHistoryMsg;
import xlrtrum.messages.GetTxMsg;
import xlrtrum.messages.ListUnspentMsg;
import xlrtrum.messages.Method;
import xlrtrum.messages.SubscribeAddressMsg;
...
public class XlrtrumPeer implements IoHandler{

    private final Logger log;

    /** Peer data */
    private XlrtrumPeerData peerData;
    /**  */
    ...
    public XlrtrumPeer(XlrtrumPeerData peerData,IoManager ioManager,VersionMsg versionMsg) {
        this.peerData = peerData;
        this.ioManager = ioManager;
        this.versionMsg = versionMsg;
        this.log = LoggerFactory.getLogger(XlrtrumPeer.class.getName()+"-"+peerData.getHost());
    }
    ...
    public void connect() throws ConnectionFailureException, InterruptedException {
        if (isInitilizing.compareAndSet(false,true) && !isRunning.get()) {
            ...
            throw new IllegalStateException("XlrtrumPeer already initializing");
        }
    }
    ...
    public XlrtrumPeerData getPeerData() {
        return peerData;
    }
