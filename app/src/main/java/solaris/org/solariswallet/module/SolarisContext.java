...
public class SolarisContext {
    ...
    /** Solaris wallet released time */
    public static final long SOLARIS_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME = 1520495875;
    ...
    public static final class Files{
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "solaris-wallet-backup" +"_"+ FILENAME_NETWORK_SUFFIX;
