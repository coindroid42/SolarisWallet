...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final SolarisApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (SolarisContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + SolarisContext.NETWORK_PARAMETERS.getId() + "\n");
