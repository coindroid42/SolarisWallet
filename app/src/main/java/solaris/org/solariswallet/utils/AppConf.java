...
import static solaris.org.solariswallet.module.SolarisContext.DEFAULT_RATE_COIN;
...
public class AppConf extends Configurations {
    ...
    public void saveTrustedNode(XlrtrumPeerData pivtrumPeerData){
