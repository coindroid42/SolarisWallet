...
import solaris.org.solariswallet.ui.address_add_activity.AddContactActivity;
...
public class DialogsUtil {
    ...
    public interface TrustedNodeDialogListener{
        void onNodeSelected(XlrtrumPeerData pivtrumPeerData);
    }
        ...
        nodeDialog.setPositiveButton("Add Node", new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int which) {
                if (!flag.getAndSet(true)) {
                    ...
                    int tcpPort = SolarisContext.NETWORK_PARAMETERS.getPort();
                    if (host.equals(XlrtrumGlobalData.FURSZY_TESTNET_SERVER)){
                        tcpPort = 8443;
                    }
                    int sslPort = 0;
