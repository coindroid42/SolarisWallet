package solaris.org.solariswallet.ui.transaction_request_activity;
...
import solaris.org.solariswallet.ui.transaction_send_activity.AmountInputFragment;
import solaris.org.solariswallet.ui.transaction_send_activity.MyFilterableAdapter;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        String solarisURI = SolarisURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(solarisURI);
        qrDialog.setQrText(solarisURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String solarisURI) throws WriterException {
