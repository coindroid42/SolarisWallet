package solaris.org.solariswallet.ui.words_restore_activity;
...
import solaris.org.solariswallet.ui.transaction_send_activity.MyTextWatcher;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = solarisModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            solarisModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            solarisModule.restoreWallet(mnemonic, SOLARIS_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, SolarisContext.ENABLE_BIP44_APP_VERSION));
