...
import static solaris.org.solariswallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(SolarisModule solarisModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(solarisModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = SolarisApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String solarisUri = SolarisURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(solarisUri,address.toBase58());
            }
    ...
    public void setModule(SolarisModule module) {
        this.module = module;
    }
