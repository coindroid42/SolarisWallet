package solaris.org.solariswallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = solarisModule.backupWallet(backupFile, firstPassword);

            if (result){
                solarisApplication.getAppConf().setHasBackup(true);
