package solaris.org.solariswallet.ui.export_account;
...
import solaris.org.solariswallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = solarisModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(SolarisContext.NETWORK_PARAMETERS);
