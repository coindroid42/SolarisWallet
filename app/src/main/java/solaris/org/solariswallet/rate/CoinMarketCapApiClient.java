...
public class CoinMarketCapApiClient {
    ...
    public class SolarisMarket{
        ...
        public SolarisMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public SolarisMarket getSolarisPxrice() throws RequestSolarisRateException{
        try {
            SolarisMarket solarisMarket = null;
            String url = this.URL + "ticker/solaris/";
            ...
            if (httpResponse.getStatusLine().getStatusCode()==200){
                ...
                solarisMarket = new SolarisMarket(
            ...
            return solarisMarket;
        } catch (ClientProtocolException e) {
            e.printStackTrace();
            throw new RequestSolarisRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestSolarisRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestSolarisRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestSolarisRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
